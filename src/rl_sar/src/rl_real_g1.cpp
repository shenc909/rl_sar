...
void RL_Real::GetState(RobotState<float> *state)
{
    ...
    this->control.x = this->gamepad.ly * joystick_scale[1];    // LY
    this->control.y = -this->gamepad.lx * joystick_scale[0];   // LX
    this->control.yaw = -this->gamepad.rx * joystick_scale[2]; // RX
